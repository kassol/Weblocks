...
This throwaway prototype asks whether four declarative condition types are enough to judge representative V1 Challenges with multiple valid Builds, without arbitrary scripting:
